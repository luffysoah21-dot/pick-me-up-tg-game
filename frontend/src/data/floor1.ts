                            ...
                            maxHp: 240,
                                atk: 38,
                                    def: 12,
                                        speed: 8,
                                            skills: [
                                                      { name: "عواء الظلام", damage: 45, cooldown: 2, effect: "يخفض دفاع الفريق 20%" },
                                                            { name: "قضمة مميتة", damage: 60, cooldown: 3, effect: "نزيف لمدة 2 دور" }
                                            ],
                                ...
                                maxHp: 500,
                                    atk: 52,
                                        def: 35,
                                            speed: 5,
                                                skills: [
                                                          { name: "قبضة الحديد", damage: 70, cooldown: 2, effect: "يصعق ويوقف بطل واحد دوراً" },
                                                                { name: "درع فولاذي", damage: 5, cooldown: 4, effect: "يرفع دفاعه 50% لدورين" }
                                                ],
                                ...
                                maxHp: 320,
                                    atk: 68,
                                        def: 8,
                                            speed: 10,
                                                skills: [
                                                          { name: "نار الدماء", damage: 85, cooldown: 2, effect: "حرق لمدة 3 أدوار" },
                                                                { name: "امتصاص الروح", damage: 40, cooldown: 3, effect: "تسترجع HP بقدر الضرر" }
                                                ],
                                        ...
                                        atk: 95,
                                            def: 40,
                                                speed: 7,
                                                    isBoss: true,
                                                        skills: [
                                                                  { name: "غضب الحارس", damage: 120, cooldown: 2, effect: "يضرب الفريق بالكامل" },
                                                                        { name: "طاقة الظلام", damage: 80, cooldown: 3, effect: "يستعيد 2000 HP" },
                                                                              { name: "ضربة الفناء", damage: 200, cooldown: 5, effect: "تقتل بطلاً فورياً إذا HP أقل 30%" }
                                                        ],
