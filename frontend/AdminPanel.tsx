...
export default function AdminPanel() {
  ...
  return (
    <div style={{ padding: 16, direction: "rtl", color: "#fff", display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <button onClick={() => { localStorage.removeItem("my_heroes"); localStorage.removeItem("my_team"); notify("✅ تم حذف الأبطال"); }} style={{ background: "rgba(239,68,68,0.15)", border: "1px solid rgba(239,68,68,0.3)", borderRadius: 10, padding: 12, color: "#F87171", cursor: "pointer", fontWeight: 700 }}>
